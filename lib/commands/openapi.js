...
module.exports = {
  ...
  _parseOpenapi: function(data) {
    ...
    let deferred = q.defer();
    let version3=false; 
    if (data.hasOwnProperty('openapi') && data.openapi >= "3") {
      self.ui.writeLine(`Found version 3+ openapi document`);
      version3=true
    }
    // Check for definitions
    let definitions = null; 
    if ( (!version3 && data.hasOwnProperty('definitions')) || 
          (version3 && data.hasOwnProperty('components'))) {
            if (version3) {
